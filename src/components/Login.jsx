...
function Login() {
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id:
        "910275264123-fldtjgd3317ec0d76ipmtabo4n0c5u64.apps.googleusercontent.com",
        ...
        {user && (
          <div className="userIds">
            ...
            <div className="connect">
              <span className="enTantque">
                connecté <FaCircle className="Circle" />
              </span>
